...
if (Config.WORKTYPE == 'private') {
    ...
    WhatsAlexa.addCommand({pattern: 'qr ?(.*)', fromMe: true, desc: Lang.QR_DESC}, (async (message, match) => {
        ...
        await message.sendImage(Buffer.from(webimage.data), '*Made By WhatsAlexa*');

    }));

    WhatsAlexa.addCommand({pattern: 'readqr ?(.*)', fromMe: true, desc: Lang.QR_DESC}, (async (message, match) => {
    ...
    WhatsAlexa.addCommand({pattern: 'readqr ?(.*)', fromMe: false, desc: Lang.QR_DESC}, (async (message, match) => {
